...
| ------------------------------------------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------ |
| [in-field-update-mechanism.html](partial/in-field-update-mechanism.html) | Variant A (desktop self-update) fully shipped: version detection, notification popup, status-bar indicator, Settings page, skip/security bypass, release-notes security marker (#1878, closed) | Variants B/C (download-and-prompt / auto-install) deliberately unbuilt — gated on paid code-signing certificates, a maintainer/budget decision (no implementation issue) |
