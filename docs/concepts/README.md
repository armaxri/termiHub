...
[`implemented/ai-driven-concept-workflow.md`](implemented/ai-driven-concept-workflow.md) for the full
...
| [ai-driven-concept-workflow.md](implemented/ai-driven-concept-workflow.md)                         | Single-file HTML concept workflow — mockup kit, `/sync-concept` skill, screenshot + gallery tooling (in active use)           |
| [cross-platform-testing.md](implemented/cross-platform-testing.md)                                 | CI test matrix runs across macOS, Linux, and Windows                                                                          |
...
| [ftp-client.html](partial/ftp-client.html)                                           | FTP/FTPS backend, listing parsers, file-browser CRUD, shared Transfer Queue (model + panel), insecure-FTP warning, robustness (epic #1331)                                                  | Connection-type-agnostic file-browser sidebar wiring — SI-4, tracked in issue #1335                                                    |
...
| [elevated-sftp-editing.html](backlog/elevated-sftp-editing.html)                                       | Elevated (sudo) SFTP file editing — read-only detection shipped (#969); the sudo re-save is unbuilt, pending system tests + user acceptance |
