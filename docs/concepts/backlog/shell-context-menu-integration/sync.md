# Sync Ledger — Shell Context Menu & CLI Spawn Integration

**Last synced:** never (concept not yet implemented)
**Status:** diverged (entirely missing — backlog feature)

This ledger is maintained by the `/sync-concept shell-context-menu-integration` skill. It records
the last commit at which the concept artifacts and the code were reconciled, plus any open
divergences.
