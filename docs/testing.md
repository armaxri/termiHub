...
| -------------------- | ------------------------------------------------- | ----- | ------------------------------------------ | ----------------------------------------------------------------- |
| SSH Auth             | `core/tests/ssh_auth.rs`                          | 14    | ssh-password:2201, ssh-keys:2203           | Password, 6 key types, 5 passphrase keys, wrong credentials       |
...
| SSH Banner           | `core/tests/ssh_banner.rs`                        | 2     | ssh-banner:2206, ssh-password:2201         | Pre-auth banner text, no-banner on standard server                |
