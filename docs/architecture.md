...
when they diverge (e.g. a moved portable install) — see [ADR-12](#adr-12-multi-instance-with-a-spawn-ipc-rendezvous).
...
### ADR-12: Multi-Instance with a Spawn IPC Rendezvous
