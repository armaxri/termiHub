...
| `transfer-cancel` | `src/components/TransferQueue/TransferControls.tsx` |
| `transfer-cancel-all` | `src/components/TransferQueue/TransferQueue.tsx` |
| `transfer-clear-completed` | `src/components/TransferQueue/TransferQueue.tsx` |
| `transfer-minimize` | `src/components/TransferQueue/TransferQueue.tsx` |
| `transfer-pause` | `src/components/TransferQueue/TransferControls.tsx` |
| `transfer-queue` | `src/components/TransferQueue/TransferQueue.tsx` |
| `transfer-queue-indicator` | `src/components/TransferQueue/TransferQueueIndicator.tsx` |
| `transfer-queue-summary` | `src/components/TransferQueue/TransferQueue.tsx` |
| `transfer-remove` | `src/components/TransferQueue/TransferControls.tsx` |
| `transfer-resume` | `src/components/TransferQueue/TransferControls.tsx` |
| `transfer-retry` | `src/components/TransferQueue/TransferControls.tsx` |
| `transfer-row` | `src/components/TransferQueue/TransferEntry.tsx` |
| `transfer-row-name` | `src/components/TransferQueue/TransferEntry.tsx` |
| `transfer-row-status` | `src/components/TransferQueue/TransferEntry.tsx` |
