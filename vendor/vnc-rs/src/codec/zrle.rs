...
use super::{zeroed_vec, zlib::ZlibReader};
...
impl Decoder {
        ...
        Fut: Future<Output = Result<(), VncError>>,
    {
        ...
        // A decompressor left empty by an earlier failed decode is an error, not
        // an `unwrap()` panic (the zlib stream state is gone with it).
