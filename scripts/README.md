...
| `run-guided-manual`       | Starter for the **guided-manual** operator suite (`--manual`) — resolves the X11 display per-OS, brings up the SSH fixtures, and tees the full transcript to a gitignored `tests/reports/manual-run.log` |
