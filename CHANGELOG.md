...
- Settings: files with extensions listed in the grammar's `fileTypes` field are now auto-detected as the custom language when opened in the file editor — no manual File Type Mapping step required for grammars that declare their file types (#556)
