...
- File editor: added syntax highlighting for CMake, TOML, Nginx, Nix, and Java `.properties` files via custom Monaco Monarch tokenizers; `.nix` and `.toml` files now highlight instead of showing as plain text (#498)
