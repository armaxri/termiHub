...
// buffer/scrollToBottom/refresh spies are the module-level ones the test asserts.
vi.mock("@xterm/xterm", async () => {
  const { MockXTerm } = await import("@/test/mockXterm");
  class OutputRepaintXTerm extends MockXTerm {
  ...
  return { Terminal: OutputRepaintXTerm };
});
