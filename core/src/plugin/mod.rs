...
pub use manager::{
    read_stored_settings, resolve_plugin_settings, resolve_plugin_settings_json, InstalledPlugin,
    NoopLifecycleHook, PluginLifecycleHook, PluginManager, PluginManagerError, PluginState,
};
pub use manifest::{
